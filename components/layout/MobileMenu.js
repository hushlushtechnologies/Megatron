    ...
    return (
        <>
            <ul className="navigation clearfix">
                <li className={isActive.key == 1 ? "dropdown current" : "dropdown2"} onClick={() => handleClick(1)}>
                    <Link href="/#">Home</Link>
                ...
                <li className={isActive.key == 2 ? "dropdown current" : "dropdown2"} onClick={() => handleClick(2)}>
                ...
                <li className={isActive.key == 3 ? "dropdown current" : "dropdown2"} onClick={() => handleClick(3)}>
