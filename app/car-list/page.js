                    ...
                    >
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="Crossover" className="option">
                              Crossover
                            </option>
                            <option data-value="Compact" className="option">
                              Compact
                            </option>
                            <option data-value="Convertible" className="option">
                              Convertible
                            </option>
                            <option data-value="Hatchback" className="option">
                              Hatchback
                            </option>
                            <option data-value="Sedan" className="option">
                              Sedan
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="Acura" className="option">
                              Acura
                            </option>
                            <option data-value="Audi" className="option">
                              Audi
                            </option>
                            <option data-value="Bentley" className="option">
                              Bentley
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="3 Series" className="option">
                              3 Series
                            </option>
                            <option
                              data-value="718 Boxster T"
                              className="option"
                            >
                              718 Boxster T
                            </option>
                            <option data-value="718 Cayman" className="option">
                              718 Cayman
                            </option>
                            <option
                              data-value="911 Carrera 4"
                              className="option"
                            >
                              911 Carrera 4
                            </option>
                            <option data-value="A4" className="option">
                              A4
                            </option>
                            <option data-value="Bentayga" className="option">
                              Bentayga
                            </option>
                            <option
                              data-value="Bentayga Azure"
                              className="option"
                            >
                              Bentayga Azure
                            </option>
                            <option
                              data-value="Bentayga Technology"
                              className="option"
                            >
                              Bentayga Technology
                            </option>
                            <option data-value="C Class" className="option">
                              C Class
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="Diesel" className="option">
                              Diesel
                            </option>
                            <option data-value="Electric" className="option">
                              Electric
                            </option>
                            <option data-value="Gasoline" className="option">
                              Gasoline
                            </option>
                            <option data-value="Hybrid" className="option">
                              Hybrid
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="Auto" className="option">
                              Auto
                            </option>
                            <option data-value="CVT" className="option">
                              CVT
                            </option>
                            <option data-value="DCT" className="option">
                              DCT
                            </option>
                            <option data-value="MT" className="option">
                              MT
                            </option>
                          </select>
                        </div>
                        ...
                        <div className="form-group">
                          <div className="group-select">
                            <select className="nice-select">
                              ...
                              <option data-value={2021} className="option">
                                2021
                              </option>
                        ...
                        <div className="form-group">
                          <div className="group-select">
                            <select className="nice-select">
                              ...
                              <option data-value="FWD" className="option">
                                FWD
                              </option>
                              <option data-value="AWD" className="option">
                                AWD
                              </option>
                              <option data-value="4WD" className="option">
                                4WD
                              </option>
                      ...
                      <div className="form-group">
                        <div className="group-select">
                          <select className="nice-select">
                            ...
                            <option data-value="Red" className="option">
                              Red
                            </option>
                            <option data-value="White" className="option">
                              White
                            </option>
                            <option data-value="Yellow" className="option">
                              Yellow
                            </option>
                            <option data-value="Blue" className="option">
                              Blue
                            </option>
                          </select>
                        </div>
                      ...
                      <div className="form-group">
                        <input
                          ...
                          className="form-control"
                          name="mileage"
                          defaultValue="Enter Engine Size"
                        />
                      </div>
                      <div className="form-group">
                        <input
                                    ...
                                    >
                                      <div className="images">
                                        ...
                                        <div className="overlay-limit">
                                          ...
                                          />
                                          <p>
                                            {car.images.length - 2} more photos
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                            ...
                            <div className="listing-item-content">
                              ...
                              <div className="bottom-price-wrap">
                                <div className="price-wrap">
                                    <p className="price">{car.currency} {Number(car.price).toLocaleString()}</p>
                                    <p className="price-sale">{car.currency} {Number(car.salePrice).toLocaleString()}</p>
                                  </div>
